...
private:
    ...
    // pipeline
    ID3D12Device9              * device;                    // dispositivo gráfico
    ...
    ullong                       fenceValue;				// número atual da barreira
...
public:
    ...
    ID3D12Device9* Device();                                // retorna dispositivo Direct3D
...
inline ID3D12Device9* Graphics::Device()
{ return device; }
